...
export class Backend implements backendInterface {
    ...
    async assignKarigar(arg0: Date_, arg1: Array<string>, arg2: string, arg3: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignKarigar(arg0, arg1, arg2, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyOrders(arg0: Date_): Promise<Array<DailyOrder>> {
        if (this.processError) {
            try {
    ...
    async getKarigarMappingWorkbook(): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
    ...
    async storeDailyOrders(arg0: Date_, arg1: Array<DailyOrder>): Promise<void> {
        if (this.processError) {
            try {
